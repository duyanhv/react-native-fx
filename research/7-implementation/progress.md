...
| U6-002 | Unit 6 | device-verify | todo | yes | — | RT-016 | U6-001 (merged) | device: animators handle hard retarget, else build integrator; **spec'd (planner, 2026-06-12)** — [task](./tasks/U6-002/) (the nine-row matrix: timing sweep, reversal/extension, rapid-fire, zero-displacement, after-rest boundary, rotation+combined channels, mixed clip/carry, cancel-under-fire, JS silence) |
