...
| U3-001 | Unit 3 | implement | in-progress | yes | FX-004 | RT-009 | U1-002, U2-001, DOC-007, DOC-008 | spec'd; staged: RT-009 + fill (iOS+Android) + iOS material; shader by DOC-007; symbol iOS by DOC-008; Android material out of scope (U3-003 owns it); [detail](#u3-001--hosted-effect-renderer) |
