...
| U6-001 | Unit 6 | implement | spec'd | yes | RT-007 | RT-007 | U4-001, U5-001 | device: interruptible spring, no snap; spring dispositions pre-ratified (DOC-009) — [preflight](./tasks/U6-001/preflight.md); spec'd by the planner (2026-06-11) — [task](./tasks/U6-001/) is the work order; RT-007 closes only on the device gate; U6-002 owns RT-016's device truth |
