...
| U3-001 | Unit 3 | implement | headless-done | yes | FX-004 | RT-009 | U1-002, U2-001, DOC-007, DOC-008 | implemented: hosted mount + prop plumbing (RT-009), fill on iOS+Android, material iOS only; device scenario written; [detail](#u3-001--hosted-effect-renderer) |
...
Type: `implement` · State: `headless-done` · Device: yes · Consumes: FX-004 · Closes: RT-009 · [task](./tasks/U3-001-effect-renderer-hosted/)
