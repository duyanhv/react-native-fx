...
export type DemoScreen = "all-api-chat" | "fill-material" | "shaders" | "content-motion" | "content-distort" | "symbol" | "android-material" | "hosting-parity" | "stress-list" | "presence" | "coexistence" | "source-scroll" | "runtime-shader" | "controlled-write" | "drag-axis-spike" | "effect-surface" | "fx-pressable" | "fx-view" | "glass-morph" | "reveal" | "blank";
...
export const TASKS: DeviceTask[] = [
	{
		id: "EX-003",
		title: "All API chat screen",
		platform: "iOS · Android",
		what: "ChatGPT-style harness that composes FxPresence, FxView, FxPressable, Fx, EdgeGlow, FxGroup/FxItem, FxReveal, Fx.Scroll, registries, and low-level hosts",
		status: "in-progress",
		screen: "all-api-chat",
	},
	{
